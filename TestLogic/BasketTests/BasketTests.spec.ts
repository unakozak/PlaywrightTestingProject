...
test.describe('Basket Tests', async () => {
    ...
    test("TC03. Open a basket with 1 sale item. ***.", async ({ page, baseURL }) => {
    ...
    test("TC04. Open a basket with 9 different products. ***.", async ({ page, baseURL }) => {
        // test.fail(true, 'Issue #02. After adding discount item basket icon in header disappears'); 
        const pageManager = new PageManager(page);
    ...
    test("TC05. Open a basket with 9 sale items of the same name. ***.", async ({ page, baseURL }) => {
        // test.fail(true, 'Issue #02. After adding discount item basket icon in header disappears'); 
        const pageManager = new PageManager(page);
